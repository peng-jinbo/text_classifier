...
# Path of train data in txt format.
train_txt_path = "/home/datamerge/SIGIR/Data/Train/new_preprocess_train_mag.txt"

# Path for pickle cache.
cache_path = os.path.join("./data_cache.pickle")
